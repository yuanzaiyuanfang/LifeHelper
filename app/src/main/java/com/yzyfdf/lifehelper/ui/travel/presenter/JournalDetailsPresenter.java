...
public class JournalDetailsPresenter extends JournalDetailsContract.Presenter {


    @Override
    public void getRouteDetails(String url) {
        mRxManage.add(mModel.getRouteDetails(url).subscribe(new RxSubscriber<JournalDetailsBean>(mContext,true) {
            @Override
            protected void _onNext(JournalDetailsBean bean) {
    ...
    @Override
    public void getRecyclerViewData(JournalDetailsBean bean) {
