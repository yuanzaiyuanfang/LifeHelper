...
public class RoutesModel implements RoutesContract.Model {
    ...
    @Override
    public Observable<List<TravelRoutesBean.ItemsBean>> getRoutes(int num) {
        return Api.getInstance().getRoutes(mContext, num)
                .map(TravelRoutesBean::getItems)
