...
import com.yzyfdf.lifehelper.bean.travel.TravelBaseBean;
...
public class JsonConvertTravel<T extends TravelBaseBean> implements Converter<T> {
    ...
    public T convertSuccess(Response response) throws Exception {
        ...
        try {
            ...
            if (!TextUtils.equals(t.getStatus().toLowerCase(), "ok")) {
