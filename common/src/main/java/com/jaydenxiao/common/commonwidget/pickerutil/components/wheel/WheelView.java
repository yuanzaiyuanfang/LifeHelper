package com.jaydenxiao.common.commonwidget.pickerutil.components.wheel;
...
import com.jaydenxiao.common.commonwidget.pickerutil.components.wheel.adapter.WheelViewAdapter;
...
//    private static final int[] SHADOWS_COLORS = new int[]{0xFF111111, 0x00AAAAAA, 0x00AAAAAA};
    private static final int[] SHADOWS_COLORS = new int[]{0xFFffffff, 0x80ffffff, 0x00ffffff};
